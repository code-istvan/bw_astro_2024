...
CREATE TABLE IF NOT EXISTS attendances ( id TEXT PRIMARY KEY, user_id TEXT NOT NULL, pass_id TEXT NOT NULL, class_id TEXT, attendance_date DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, internal_notes TEXT,  FOREIGN KEY (user_id) REFERENCES users(id), FOREIGN KEY (pass_id) REFERENCES passes(id) );
...
CREATE INDEX idx_user_passes_pass_id ON user_passes(pass_id);
COMMIT;
