...
const BwLogoText = (props) => {
    ...
    return (
        ...
        >
            <g id="logo_text">
                <path
                    d="M10,27.8l-1.9-8.2h0l-1.9,8.2H3.3L0,15.1h3.3L5,23.3h0l1.9-8.2h2.5l1.8,8.2h0l1.7-8.2h3.3l-3.3,12.6H10z"
                    fill={fillColor}
                />
                <path
		...
		l3.4,4.3H37.8z M36.1,21.5c1.3,0,2.1-0.6,2.1-1.8c0-1.1-0.8-1.7-2-1.7h-1.2v3.5H36.1z"
                ...
                />
                <path
                    d="M50,27.8l-3.4-5.5h0v5.5h-3.2V15.1h3.2v5.7h0l3.6-5.7h3.4l-4.2,6.3l4.5,6.3H50z"
                    fill={fillColor}
                />
                <path
		...
		c1,0,1.5-0.4,1.5-1.3C6.5,8.3,6,7.9,5,7.9H3.3v2.4H5z"
                ...
                />
                <path
                    d="M20,13.3l-0.6-1.9h-4.6l-0.7,1.9h-3.7L15.8,0h2.7l5.3,13.3H20z M17.1,4.2L17.1,4.2l-1.4,4.5h2.8L17.1,4.2z"
                    fill={fillColor}
                />
                <path
                    d="M33.4,13.3l-5.1-8.1l0.1,8.1h-3.3V0H28l5.2,8.4L33,0h3.3v13.3H33.4z"
                    fill={fillColor}
                />
                <path
		...
		c2,0,3.2-1.2,3.2-3.7c0-2.4-1.2-3.7-3.2-3.7h-1.5v7.3H43.5z"
                ...
                />
                <path
                    d="M59.8,13.3V8h-4.4v5.3h-3.4V0h3.4v5h4.4V0h3.4v13.3H59.8z"
                    fill={fillColor}
                />
                <path
        ...
        <a href={props.url} target="_blank" rel="noreferrer">
            ...
            >
                <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M20 40C31.0459 40 40 31.0449 40 20C40 8.95508 31.0459 0 20 0C8.9541 0 0 8.95508 0 20C0 31.0449 8.9541 40 20 40ZM31.5273 8H27.542L20.8965 15.6699L15.2222 8H7L16.79 21.1074L7.52002 32H11.5054L18.6963 23.6035L24.9775 32H33L22.7769 18.1836L31.5273 8ZM28.3564 29.6094H26.147L11.687 10.3027H14.061L28.3564 29.6094Z"
                />
            </svg>
        </a>
    );
